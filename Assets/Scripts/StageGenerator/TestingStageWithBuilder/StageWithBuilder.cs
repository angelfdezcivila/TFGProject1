...
namespace TestingStageWithBuilder
{
    public class StageWithBuilder
    {
        ...
        protected StageWithBuilder(GameObject cellPrefab, Transform transformParent)
        {
            InitializeConstants(cellPrefab, transformParent,new Vector2(1f, 1f), 10, 10);
        }
        
        protected StageWithBuilder(GameObject cellPrefab, Vector2 cellsDimension, Transform transformParent, int rows,
            int columns)
        {
        ...
        public class Builder {
            ...
            public StageWithBuilder build() {
                return new StageWithBuilder(_cellsPrefab, _cellsDimension, _transformParent, _rows, _columns);
            }
